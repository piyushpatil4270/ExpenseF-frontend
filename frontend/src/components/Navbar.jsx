...
const Navbar = ({isPremium,setPremium,setIsAuth}) => {
  ...
  return (
    <div className='w-full xs:h-[90px] sm:h-[110px]  bg-[#50bcbd] flex flex-col items-center xs:gap-[4px] sm:gap-[12px]'>
        <div className='w-full flex my-2   px-1  items-center justify-center '>
         <div className='xs:w-[70%] sm:w-[70%] xs:mx-[4] '>
         ...
         <div className='flex justify-center  xs:gap-5 gap-6'>
         <button className='  xs:text-[10px] sm:text-[13px] text-white bg-slate-300  rounded-sm'onClick={()=>{
          setIsAuth(false)
        ...
        <div className='w-full flex justify-center items-center sm:gap-[50px] xs:gap-6 xs:my-2 my-1'>
          <Link to={"/"}>
